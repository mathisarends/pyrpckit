...
| `_core.ts` | private, einmalige Verbindung zwischen APIs und Transport |
| `api/…` | API-Gruppen und Operationsmethoden |

`_core.ts` beginnt mit einem Unterstrich, weil es kein Consumer-Einstiegspunkt
ist. API-Dateien dürfen es importieren; `index.ts` exportiert es nicht.
...
// Generated by pyrpckit from browser-control.openrpc.json.
// Do not edit this file manually.
import type { RpcClientCore } from "../_core";
...
// Generated by pyrpckit from browser-control.openrpc.json.
// Do not edit this file manually.
import { RpcRemoteError } from "./_core";
...
Routenmetadaten aus `/metadata` importiert. API-Gruppen und `_core.ts` werden
