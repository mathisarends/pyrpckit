...
`RpcConnectedClient` represents the connected client. It is injectable wherever
`RpcConnection` is. Keep connected clients in your own registry to call a client from
