...
class WebSocketTransport:
    def __init__(
        ...
        *,
        ...
        if notification_overflow not in ("drop_oldest", "close"):
            raise ValueError("notification_overflow must be 'drop_oldest' or 'close'")
        self._socket = socket
        ...
        self._notification_listener = False
            ...
            while True:
                ...
                if "id" in message and isinstance(message.get("method"), str):
                    ...
                    try:
                        ...
                        if self._notification_overflow == "close":
                            raise RpcTransportError(
        ...
        if isinstance(error, dict):
            ...
            response.set_exception(
                error_from_response(
                    ...
                    str(data.get("code", "")) if isinstance(data, dict) else "",
                    str(error.get("message", "Remote RPC error")),
                    data.get("details") if isinstance(data, dict) else None,
                )
            )
