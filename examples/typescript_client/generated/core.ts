...
export class RpcClientCore {
  ...
  async *notifications<Notification>(): AsyncIterable<Notification> {
    for await (const message of this.#transport.notifications()) {
      yield (message as { params: Notification }).params;
    }
  }
